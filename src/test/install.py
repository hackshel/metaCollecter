...
def writeConfig( path ):
    ...
    fp.write("POST_HEADER = { 'Content-type' : 'application/x-www-form-urlencoded','Accept' : 'text/json'}\n")
...
def extraTar( path , fileName  , extPath ) :
...
if __name__ == '__main__':
    ...
    ips = [ {'name':u'永丰','simple_name':'YF.BJ' ,'ip':'10.75.6.31'},
            ...
            {'name':u'亦庄','simple_name':'YZ.BJ' ,'ip':'172.16.54.66'},
    ...
    extraTar( './' , 'meta.tar.gz' , '/usr/local/' )
