...
def backupOriginalData( edb , originalData  ):
    ...
    if originalData.has_key( 'ips' ):
        ...
        r = edb.bak_ipinfos.puts( originalData['ips'] )
    ...
    if originalData.has_key( 'disksize'):
        ...
        r5 =  edb.bak_disksize.puts( originalData['disksize'] )
    ...
    if originalData.has_key( 'physical_disk' ):
        ...
        r6 =  edb.bak_physical_disk.puts( originalData['physical_disk'] )
    ...
    if originalData.has_key( 'raid' ):
        ...
        r4 =  edb.bak_raid.puts( originalData['raid'] )
    ...
    if originalData.has_key('server') :
        ...
        rrr = edb.bak_servers.puts( [originalData['server']] )

    if originalData.has_key( 'os' ):
        originalData['os']['id'] = ''
        originalData['os']['ctime'] = ''
        rr = edb.bak_os.puts( [originalData['os']] )
